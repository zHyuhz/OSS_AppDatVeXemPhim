...
public class DanhSachPhim extends AppCompatActivity {
...
//                Toast.makeText(this, "Quản lý phim được chọn", Toast.LENGTH_SHORT).show();
    ...
    private void addEvents() {
        filmAdapter.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                MovieResponse movieResponse = movieResponseList.get(position);
                Intent intent = new Intent(DanhSachPhim.this, CapNhatPhim.class);
                intent.putExtra("MOVIE", movieResponse);
                startActivity(intent);
                Toast.makeText(DanhSachPhim.this, movieResponse.getMovieName(), Toast.LENGTH_SHORT).show();
        ...
        filmAdapter.setOnItemLongClickListener((view, position) -> {
            AlertDialog.Builder builder = new AlertDialog.Builder(DanhSachPhim.this);
            builder.setTitle("XOA PHIM")
                    ...
                    .setPositiveButton("TU CHOI", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(DanhSachPhim.this, String.valueOf(which), Toast.LENGTH_SHORT).show();
                        }
                    });
        ...
        call.enqueue(new Callback<ApiResponse<String>>() {
            ...
            public void onResponse(Call<ApiResponse<String>> call, Response<ApiResponse<String>> response) {
                if (response.isSuccessful() && response.body().getCode() == 0) {
                    ...
                    Toast.makeText(DanhSachPhim.this, "Xóa thành công", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(DanhSachPhim.this, "Xóa thất bại", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<ApiResponse<String>> call, Throwable t) {
                ...
                Toast.makeText(DanhSachPhim.this, "Xay ra loi ", Toast.LENGTH_SHORT).show();
            }
        });
    }
                ...
                if (response.isSuccessful()) {
                    if (response.body() != null) {
                        ...
                        if (apiResponse.getCode() == 0) {
                            ...
                            Toast.makeText(DanhSachPhim.this, "Lỗi tại dsPhim_MainActivity", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(DanhSachPhim.this, "That bai: Do body null", Toast.LENGTH_SHORT).show();
                    ...
                    try {
                        ...
                        Toast.makeText(DanhSachPhim.this, "Error: " + errorMessage, Toast.LENGTH_SHORT).show();
                    } catch (IOException e) {
                        e.printStackTrace();
                        Toast.makeText(DanhSachPhim.this, "Error parsing error body", Toast.LENGTH_SHORT).show();
                    }
                }
            }

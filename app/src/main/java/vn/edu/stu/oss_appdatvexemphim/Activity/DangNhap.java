            ...
            public void onResponse(Call<ApiResponse<Void>> call, Response<ApiResponse<Void>> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (apiResponse.getCode() == 0) {
                        ...
                        Intent intent = new Intent(DangNhap.this,trangChu_MainActivity.class);
                        intent.putExtra("username",loginRequest.getUserName());
                        startActivity(intent);

                        Toast.makeText(DangNhap.this, apiResponse.getMessage(), Toast.LENGTH_SHORT).show();
                        //finish();
                    } else {
                        Toast.makeText(DangNhap.this, apiResponse.getMessage(), Toast.LENGTH_SHORT).show();
                    ...
                    try {
                        ...
                        if(!errorBody.equals("null")){
                            ...
                            Toast.makeText(DangNhap.this, "Lỗi không xác định", Toast.LENGTH_SHORT).show();
                        }

...
//                Intent intent = new Intent(ChiTietVe.this, trangChu_MainActivity.class);
...
//                .into(img_posterMovie);
    ...
    private void setLayout() {
        ...
        frmChiTietVe_giaTien.setText(String.valueOf(bookingResponse.getPrice()) + "00 VND");
